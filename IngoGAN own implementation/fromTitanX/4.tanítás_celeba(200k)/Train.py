...
if __name__ == "__main__":
    ...
    amount_of_used_image = len(dataset_celeba)

    dataset_celeba, _ = torch.utils.data.random_split(dataset_celeba, [amount_of_used_image,
                                                                       len(dataset_celeba) - amount_of_used_image])
    ...
    for epoch in range(num_epochs):
        ...
        bar.finish()
        print("\n[Epoch %d/%d] [D loss: %f] [D accur: %f] [G loss: %f] "
    ...
    plt.plot(range(num_epochs), Info_loss, "r-", label="Info_loss")
