...
if __name__ == "__main__":
    ...
    #IMAGE_PATH = "/home/karcsi/DAPGAN/Celeba" #titanx
    ...
    amount_of_used_images = int(len(dataset_celeba)*0.005)
    ...
    d_loss, g_loss, i_loss, disc_accuracy, z_loss, c_cat_loss, c_con_loss = train_obj.train(num_epochs=2)
    #train_obj.plot(transform, path=IMG)
    train_obj.plot(transform, path=None)
