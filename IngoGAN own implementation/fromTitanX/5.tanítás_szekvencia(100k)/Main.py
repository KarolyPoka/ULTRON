...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(dataset=dataset_celeba, batch_size=hyp["batch_size"], shuffle=True, num_workers=8, drop_last=True)
    ...
    d_loss, g_loss, i_loss, disc_accuracy, z_loss, c_cat_loss, c_con_loss = train_obj.train(num_epochs=20)
    train_obj.plot(transform, path=IMG)
    ...
    plt.figure(1)
    plt.title = "Losses after " + str(100) + " epochs"
    plt.plot(range(100), D_loss, "b-", label="D_loss")
    plt.plot(range(100), G_loss, "y-", label="G_loss")
    plt.plot(range(100), I_loss, "r-", label="I_loss")
    plt.plot(range(100), discriminator_accuracy, "g-", label="D_accuracy")
    plt.plot(range(100), Z_loss, "p-", label="Noise_loss(D)")
    plt.legend()
    #plt.show()
    plt.savefig("Losses_after " + str(100) + " epochs"+".png")

    plt.figure(2)
    plt.title = "Losses after " + str(100) + " epochs"
    plt.plot(range(100), C_cat_loss, "b-", label="C_cat_loss")
    plt.plot(range(100), C_con_loss, "y-", label="C_con_loss")
    plt.plot(range(100), Z_loss, "p-", label="Z_loss")
    plt.legend()
    #plt.show()
    plt.savefig("Q_Losses_after " + str(100) + " epochs" + ".png")
