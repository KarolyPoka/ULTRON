...
if __name__ == "__main__":
    ...
    if path.exists("DAPGAN_24.tar"):
        state = torch.load('DAPGAN_24.tar')
    ...
    d_loss, g_loss, i_loss, disc_accuracy, c_cat_loss, c_con_loss, n_loss, pred_cat, pred_con, epochs_done = train_obj.train(num_epochs=1, train_encoder=False)
    #train_obj.plot(transform, path=IMG)
    train_obj.plot(transform, path=None)
